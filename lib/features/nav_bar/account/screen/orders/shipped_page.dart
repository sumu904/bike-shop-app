...
class ShippedPage extends StatefulWidget {
  const ShippedPage({super.key});

  @override
  State<ShippedPage> createState() => _ShippedPageState();
}

class _ShippedPageState extends State<ShippedPage> {
