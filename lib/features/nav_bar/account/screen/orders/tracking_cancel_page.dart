...
class TrackingCancelPage extends StatefulWidget {
  const TrackingCancelPage({super.key});

  @override
  State<TrackingCancelPage> createState() => _TrackingCancelPageState();
}

class _TrackingCancelPageState extends State<TrackingCancelPage> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Column(children: [
                Row(children: [
                  Column(children: [
                    PointWidget(statusColor: AppColors.primaryClr,statusIcon: Icon(Icons.close,size: 15,color: AppColors.white,),),
                    Container(width: 1.5, height: 30, color: AppColors.grey2),
                    PointWidget(statusColor: AppColors.grey2,statusIcon: Icon(Icons.check,size: 15,color: AppColors.white,),),
                    Container(width: 1.5, height: 30, color: AppColors.grey2),
                    PointWidget(statusColor: AppColors.grey2,statusIcon: Icon(Icons.check,size: 15,color: AppColors.white,),),
                  ]),
                  SizedBox(width: 10),
...
class PointWidget extends StatelessWidget {
  ...
  const PointWidget({super.key, required this.statusColor,required this.statusIcon});
